...
const CourseProgress = () => {
  ...
  if (isError || !data || !data.data) return <p>Failed to load course progress</p>;
  ...
  return (
    <div className="max-w-7xl mx-auto p-4">
      <div className="flex justify-between mb-4">
        <h1 className="text-2xl font-bold">{courseTitle || "No Title Available"}</h1>
        <Button
        ...
        <div className="flex-1 md:w-3/5 h-fit rounded-lg shadow-lg p-4">
          ...
          <div className="mt-2">
            <h3 className="font-medium text-lg">
              {`Lecture ${
                lectures.findIndex((lec) => lec._id === (currentLecture?._id || lectures[0]?._id)) + 1
              }: ${currentLecture?.lectureTitle || lectures[0]?.lectureTitle || "No Lecture Title"}`}
            </h3>
          </div>
        </div>
